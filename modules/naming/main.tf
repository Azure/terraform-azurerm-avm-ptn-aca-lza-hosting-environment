...
locals {
  resource_names = {
    ...
    frontDoorUserAssignedIdentity = "${local.resource_type_abbreviations.managedIdentity}-${replace(local.naming_base, local.resource_type_token, local.resource_type_abbreviations.frontDoor)}-KeyVaultSecretUser"
