...
module "container_registry" {
  source = "./container_registry" # tflint-ignore: required_module_source_tffr1
  count  = 1
  ...
  tags                        = local.tags
  zone_redundant_enabled      = var.zone_redundant_resources_enabled
}

module "key_vault" {
  source = "./key_vault" # tflint-ignore: required_module_source_tffr1
  count  = 1
