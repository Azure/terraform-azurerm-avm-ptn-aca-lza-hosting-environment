...
# Windows VM without Application Gateway

This example demonstrates a Windows VM deployment without Application Gateway ingress. Certificates are automatically managed by the Application Gateway module when enabled.
