...
provider "azurerm" {
  features {}
  subscription_id     = "d400007b-da11-47cb-8a98-280317563bba"
...
Description: Azure region for the smoke test
...
Description: Resource group name for the smoke test

Type: `string`

Default: `"rg-aca-lza-smoke"`
